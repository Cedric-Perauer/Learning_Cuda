...
struct Resnet_C_Block: torch::nn::Module {
        ...
        Resnet(in_channels, out_channels) :
                ...
                conv1(register_module("conv1",torch::nn::Conv2d(in_channels,out_channels/4.0,3,1)));
                conv2(register_module("conv2",torch::nn::Conv2d(out_channels/4.0,out_channels/2.0,3,1)));
                conv3(register_module("conv3",torch::nn::Conv2d(out_channels/2.0,out_channels,3,1)));
...
class KeypointNet : torch::nn::Module {
      ...
      KeypointNet() :
                ...
                res1(register_module("res1",Resnet(net_size,net_size)));
		...
		out(register_module("out",torch::nn::Conv2d(8 * net_size,num_kpt,1,1,0)));
